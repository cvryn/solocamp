...
const ReviewForm = ({ albumId, songs = [], onReviewSubmitted, canLeaveReview }) => {
  ...
  return (
    <div style={{ marginTop: '20px' }}>
      {canLeaveReview && (
        <>
          <button className='leave-review-button-album-details'onClick={() => setIsFormVisible((prev) => !prev)}>
          ...
          {isFormVisible && (
            <form onSubmit={handleReviewSubmit}>
              ...
              <button className='leave-review-submit-button' type="submit" style={{ marginTop: '10px' }}>Submit Review</button>
            </form>
          )}
        </>
      )}
